/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd8312b997ed00a966ba49b4355f7b73)
// Runtime types generated with workerd@1.20260826.1 2025-06-21 nodejs_compat
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	DB: D1Database;
	RL_EXPENSIVE: RateLimit;
	RL_CHEAP: RateLimit;
	CLOUDFLARE_TOKEN: string;
	CLOUDFLARE_ACCOUNT: string;
	CLOUDFLARE_DB: string;
	KEY_SHARE_BASE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_TOKEN" | "CLOUDFLARE_ACCOUNT" | "CLOUDFLARE_DB" | "KEY_SHARE_BASE" | "RESEND_API_KEY">> {}
}
